                ...
                <div className={Style.content}>
                    <Card style={{ width: '18rem', backgroundColor: '#fff', margin: '15px 15px 15px 15px' }}>
                        ...
                        <Card.Body style={{ display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center" }}>
                            ...
                            <Link href="https://www.roblox.com/games/12524383962/UPD9-Every-Second-1-Ki-in-DBZ" style={{ fontSize: "15px" }}>Play</Link>
                        </Card.Body>
                    </Card>
                    ...
                    <Card style={{ width: '18rem', backgroundColor: '#fff', margin: '15px 15px 15px 15px' }}>
                        ...
                        <Card.Body style={{ display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center" }}>
                            ...
                            <Link href="https://www.roblox.com/games/12985134424/UPD-Clicker-Fighting-Simulator" style={{ fontSize: "15px" }}>Play</Link>
                        </Card.Body>
                    </Card>
                    <Card style={{ width: '18rem', backgroundColor: '#fff', margin: '15px 15px 15px 15px' }}>
                        ...
                        <Card.Body style={{ display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center" }}>
                            ...
                            <Link href="https://www.roblox.com/games/12995749346/UPD2-2-Naruto-But-Every-Second-1-Chakra" style={{ fontSize: "15px" }}>Play</Link>
                        </Card.Body>
